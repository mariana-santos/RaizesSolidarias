        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="row-body">
                { !habilitado && <div className="mask"> 
                    Para agendar um trabalho voluntário, habilite a área do volutário no botão acima
                </div> }
                    ...
                    <div className="novo-agendamento">
                        ...
                        <div className="horarios">
                            ...
                            <label className="horario" htmlFor="tarde">
                                Tarde
                                <input type="radio" name="turno" value="Tarde" id="tarde" defaultChecked onChange={handleSelecaoChange} />
                            </label>
                        </div>
